...
adjusted before committing to a full-size render; `render_texture` writes a PNG
to a path you give it and nothing else. Recipes composed this way open in the
editor and render identically, because it is the same engine either way.
